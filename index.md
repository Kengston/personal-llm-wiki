...
- [scheduler/](scheduler/) — плановый слой: идемпотентный sweep, дайджест, lint публичного репо: [src/scheduler/reminders.ts](src/scheduler/reminders.ts), [scheduler/reminders_spec.md](scheduler/reminders_spec.md), [src/scheduler/digest.ts](src/scheduler/digest.ts), [src/scheduler/routines.ts](src/scheduler/routines.ts), [src/scheduler/lint-public.ts](src/scheduler/lint-public.ts) (скан PII/секретов), [scheduler/run_sweep.sh](scheduler/run_sweep.sh), [scheduler/README.md](scheduler/README.md), digest-plist [scheduler/ru.secondbrain.digest.plist](scheduler/ru.secondbrain.digest.plist).
